  ...
  return (
    <div className="min-h-screen bg-slate-50 dark:bg-gray-900 font-sans text-slate-800 dark:text-slate-200">
      ...
      <nav className="fixed w-full bg-white/80 dark:bg-gray-900/80 backdrop-blur-md z-50 border-b border-slate-200 dark:border-gray-700">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <div className="flex items-center gap-4 border-l border-slate-200 dark:border-gray-700 pl-8">
                <button
        ...
        {/* Mobile Nav Dropdown */}
        {isMenuOpen && (
          <div className="md:hidden bg-white dark:bg-gray-900 border-b border-slate-200 dark:border-gray-700 p-4 space-y-4 shadow-xl">
            <a href="#features" className="block text-slate-600 dark:text-slate-300 py-2">
              Fitur
            </a>
            <a href="#how-it-works" className="block text-slate-600 dark:text-slate-300 py-2">
              Bagaimana cara bekerja?
            </a>
            <hr className="border-slate-100 dark:border-gray-700" />
            <button
              onClick={() => router.push("/login")}
              className="block w-full text-left text-slate-600 dark:text-slate-300 py-2 font-medium"
            >
              Masuk
            </button>
            <button
      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div className="space-y-8 animate-fade-in-up">
            ...
            <div className="bg-white dark:bg-gray-800 p-2 rounded-2xl shadow-xl border border-slate-100 dark:border-gray-700 max-w-md flex items-center gap-2">
              <input
                type="text"
                placeholder="e.g. Eggs, Rice, Soy Sauce..."
                className="flex-1 px-4 py-3 outline-none text-slate-700 dark:text-slate-300 placeholder:text-slate-400 dark:placeholder:text-slate-500 bg-transparent"
              />
              <button
                onClick={handleMulaiMemasakRegister}
            ...
            <div className="flex items-center gap-4 text-sm text-slate-500 dark:text-slate-400">
              <div className="flex -space-x-2">
                {[1, 2, 3, 4].map((i) => (
                  <div
                    key={i}
                    className="w-8 h-8 rounded-full bg-slate-200 dark:bg-gray-700 border-2 border-white dark:border-gray-800 flex items-center justify-center overflow-hidden"
                  >
                    <img
          ...
          <div className="relative">
            <div className="absolute -inset-4 bg-linear-to-r from-emerald-100 to-orange-100 dark:from-emerald-900/30 dark:to-orange-900/30 rounded-full blur-3xl opacity-50 -z-10"></div>
            <div className="bg-slate-100 dark:bg-gray-800 rounded-3xl overflow-hidden aspect-square shadow-2xl relative flex items-center justify-center group">
              <div className="absolute inset-0 bg-emerald-50 dark:bg-emerald-900/20 opacity-50"></div>
      ...
      {/* Footer */}
      <footer className="bg-slate-50 dark:bg-gray-900 py-12 border-t border-slate-200 dark:border-gray-700 mt-auto">
